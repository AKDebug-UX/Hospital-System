      ...
      <div className="flex mx-3 md:ml-[2em] w-full">
        <div className="pt-4 w-full">
          {show ? (
            ...
            <>
              <ul className="flex flex-col sm:grid sm:grid-cols-2 xl:grid-cols-3 mt-[6em] gap-3 w-full">
                {smallBox.map((text) => {
                  return (
                    <div className="flex flex-col bg-white w-full p-3 rounded-xl gap-4 mx-auto lg:gap-3 bg-white text-black border border-white dark:border-white shadow-mdtransform transition-transform duration-300 hover:scale-95 justify-center items-start">
                      <div className="flex flex-row gap-3 items-center justify-center">
                        <div className={`flex bg-grey p-3 font-bold text-[22px] text-[${text.color}] rounded-md items-center justify-center`}>
                          <ion-icon name={text.imgURL}></ion-icon>
                        </div>
                        <div className="font-bold">{text.title}</div>
                      </div>
                      <div className={`flex bg-grey w-full h- font-bold text-[22px] text-[${text.color}] rounded-md items-start justify-start`}>
                        <ChartDays color={text.color}/>
